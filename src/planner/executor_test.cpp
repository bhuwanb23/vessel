// =============================================================================
// Executor Smoke Test — Step 6 Phase A
// =============================================================================
// Minimal test: load a GGUF model via llama.cpp C API, run inference,
...
int main(int argc, char* argv[]) {
    ...
    if (!executor_init()) {
        fprintf(stderr, "Failed to initialize llama.cpp\n");
        return 1;
    }
    printf("  Backend initialized.\n\n");

    // Configure strategy: Full GPU, 4K context, Q8 KV
    StrategyConfig strategy;
    strategy.placement = PlacementStrategy::FULL_GPU;
    strategy.gpu_layers = 28;  // all layers
